...
def crear_tabla_coches(conexion):
    cursor = conexion.cursor()
    cursor.execute("CREATE TABLE coches(marca text, modelo text, combustible tex, transmision text, estado text, matriculacion text, kilometraje integer, potencia real, precio real)")
    conexion.commit()
...
if __name__ == "__main__":
    ...
    print("\n Consutamos los primeros 20 datos en la tabla")
